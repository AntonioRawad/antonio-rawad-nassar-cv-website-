...
/* Only Outfit needs to be preloaded for first paint (LTR/EN is the default).
   Caveat (signature, below the fold), Plex Arabic, and Heebo lazy-load on demand
   when the user actually switches locale or scrolls to the signature. This keeps
   the critical-path font weight from saturating slow connections. */
const outfit = Outfit({
  subsets: ["latin"],
